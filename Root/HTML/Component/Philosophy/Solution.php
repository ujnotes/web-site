<div id='message'>
	...
	<p>
		In the earlier article titled '<a class="content-link XURL" href='/philosophy/problem' data-target='/philosophy/problem' data-title='Philosophy'>solution</a>' - I concluded that the main problem of the present day world is only: "man's ignorance and stupidity"<br>
		<br>
	...
	<ul class="list-bullet content-list">
		<li><div>How to make people aware?
			<ul class="list-bullet content-list">
				<li><div>How to make people truthful?
					<ul class="list-bullet content-list">
						<li><div>How to make people seek the truth, and more information?
							<ul class="list-bullet content-list">
								<li><div>Emphasizing the importance and benefits of truth and its pursuit; And reminding of the consequences of lies</div></li>
								<li><div>A feedback loop, that rewards people and thus makes them feel good about knowing more</div></li>
								<li><div>Disincentivize and strongly discourage relay of misinformation</div></li>
							</ul>
						</div></li>
						<li><div>Be OK with not having an answer instead of an incorrect answer.<br>
							<ul class="list-bullet content-list">
								<li><div>Thus be OK to say "I do not know" and "I am willing to find out"</div></li>
							</ul>
						</div></li>
						<li><div>How to make people be OK with being proven wrong and face ridicule and humiliation for it; And also, not do the same to others?
							<ul class="list-bullet content-list">
								<li><div>Emphasizing the importance of truth over the littleness of momentary personal ridicule and humiliation which has no place and is simply meant to be swallowed with a deep breath</div></li>
							</ul>
						</div></li>
						<li><div>How to make people distinguish right from wrong and make them not gullible?
							<ul class="list-bullet content-list">
								<li><div>Make people aware that what they know and believe to be true can be wrong</div></li>
								<li><div>Make people take the scientific approach to deduce the truth from verifiable facts</div></li>
								<li><div>Make people aware that credential alone does not accredit the truth</div></li>
								<li><div>Make people aware of how an incorrect postulate can lead to undetectable error and incorrect "truth"</div></li>
								<li><div>Make people aware of the weaknesses of the human personality and mind that make it vulnerable into being gullible</div></li>
							</ul>
						</div></li>
					</ul>
				</div></li>
				<li><div>How to make good information more accessible?
					<ul class="list-bullet content-list">
						<li><div>Digitization of information and free publication on the internet</div></li>
						<li><div>Educating and facilitating people to be able to access and read information, by making the devices and networks cheaper</div></li>
						<li><div>Localizing information by translation and adaptation</div></li>
					</ul>
				</div></li>
			</ul>
		</div></li>
		<li><div>How to make people more selfless?
			<ul class="list-bullet content-list">
				...
				<li><div>How to make him feel bad about being selfish and doing bad?
					<ul class="list-bullet content-list">
		...
		<li><div>How to make individuals more responsible and accountable for their choices and actions?
			<ul class="list-bullet content-list">
				<li><div>Personal moral standards have to be set high, such that a person is accountable to himself first</div></li>
			</ul>
		</div></li>
		<li><div>How to protect an individual's opinion and its expression that differs from the majority?
			<ul class="list-bullet content-list">
				<li><div>"Freedom of thought and expression" should be recognized not only as fundamental rights but also as one of the most fundamental tenets of a progressive civilization; And should be endorsed and protected and endorsed all levels</div></li>
			</ul>
		</div></li>
		<li><div>How to make people embrace good ideas regardless of what old ideas they obsolesce and from where they come?
			<ul class="list-bullet content-list">
				<li><div>Making people understand that an idea's merit lies only in the progress it can effect; Everything else is secondary and often futile</div></li>
			</ul>
		</div></li>
		<li><div>How to make people not conform to a group blindly and follow through into mass hysteria?
			<ul class="list-bullet content-list">
				<li><div>Awareness of our inherent propensity towards tribalism</div></li>
				<li><div>Building a strong character - that can stand alone and relies on truth and is not dependent on the validation of the crowd</div></li>
			</ul>
		</div></li>
		<li><div>How to promulgate and reinforce these 'feelings' to perpetuate goodness
			<ul class="list-bullet content-list">
				<li><div>The arts and literature, broadcasting through various channels have always had a major role. The focus though needs to be more coherent so that more and more people experience these feelings and learn its connections</div></li>
				<li><div>The people, especially those who command an audience, have to be the conduits of the good change. They must also be aware of their responsibility of not igniting and amplifying the regressions</div></li>
				<li><div>People in competition, like the politicians or sportsmen should not harbor and thus also not display personal animosity. This chivalry of respecting the 'enemy' helps propel the right feelings and values and curbs the bad ones</div></li>
			</ul>
		</div></li>
	</ul>
</div>
