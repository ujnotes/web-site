<div id='message'>
	...
	<h3>The rules of chess analogy</h3>
	<p>
	...
	<ul class="list-bullet content-list">
		<li><div><strong>Euclid's postulates</strong> — Euclid founded classical geometry on five simple geometric assumptions, such as the statement that a straight line segment can be drawn between any two points.</div></li>
		<li><div><strong>The Peano axioms</strong> — Giuseppe Peano defined arithmetic on natural numbers using a few minimalist rules about zero and the concept of a successor number.</div></li>
	</ul>
	<h3>What happens when you change an axiom?</h3>
	<p>
