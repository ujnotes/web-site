<div id='message'>
		<?php $alt='A hyperbolic curve splitting dramatically toward positive and negative infinity near the vertical axis.'; require('../HTML/Fragment/Component_cover.php') ?>
