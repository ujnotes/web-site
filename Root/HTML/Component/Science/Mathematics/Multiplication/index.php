<div id='message'>
		<?php $alt='A neat rectangular grid of identical elements illustrating repeated groups and area scaling.'; require('../HTML/Fragment/Component_cover.php') ?>
	<h2 class='center'><?php echo $desc; ?></h2>
	<h3>What is multiplication?</h3>
	<p>
		At its root, multiplication is applied addition: adding the same quantity repeatedly. Writing <strong>3 × 4</strong> means taking 4 and adding it 3 times: <strong>4 + 4 + 4 = 12</strong>.
	</p>
	<h3>From repeated addition to grids and area</h3>
	<p>
	...
	<p>
		If you rotate the tray a quarter turn, you now have 4 rows of 3 eggs. The total count does not change. This simple rotation provides an immediate visual proof of <strong>commutativity</strong>:
	</p>
	<p>
	...
	<h3>Scaling and continuous quantities</h3>
	<p>
