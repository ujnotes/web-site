<div id='message'>
		<?php $alt='A system’s ability to store charge when its voltage changes.'; require('../HTML/Fragment/Component_cover.php') ?>
	<h2 class='center'><?php echo $desc; ?></h2>
	<h3>What is capacitance?</h3>
	<p>
		Capacitance is the ratio of stored charge to voltage: <strong>C = Q/V</strong>.
	</p>
	<p>
	...
	<p>
		Together with resistance it creates a time scale <strong>τ = R C</strong>. Together with inductance it can create oscillation.
	</p>
	<h3>Future</h3>
	<p>
