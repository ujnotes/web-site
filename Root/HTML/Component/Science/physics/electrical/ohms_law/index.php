<div id='message'>
		<?php $alt='A simple relationship among voltage, current and resistance.'; require('../HTML/Fragment/Component_cover.php') ?>
	<h2 class='center'><?php echo $desc; ?></h2>
	<h3>What is Ohm's law?</h3>
	<p>
		Ohm's law states that for an ideal ohmic component, <strong>V = I R</strong>.
	</p>
	<p>
		Voltage is measured in volts, current in amperes and resistance in ohms.
	</p>
	<p>
		The same relationship can be rearranged as <strong>I = V/R</strong> and <strong>R = V/I</strong>.
	</p>
	<h3>What does it explain?</h3>
	<p>
