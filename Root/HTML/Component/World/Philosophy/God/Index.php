<div id='message'>
	...
	<p>
		First, it is important to understand that overall, 'god' &ndash; the word, is an umbrella term.<br>
	...
	<div class="indent-c">
		<table>
			<tr>
				...
				<td>
					 - of this universe that we are a part of
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					- who created us humans, the chosen children of god and all else.
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					- who runs this show, and keeps accounts of karma of each and every individual.
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					- that inspires goodness and just action
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					- for things that are beyond our present knowledge
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					- all that exists, ever did and ever will
				</td>
			</tr>
		</table>
	</div>
	...
	<p>
		The laws of nature dictates this type of 'god'. The observations and the laws inferred by man from those observations makes this type of god increasingly more
	...
	<p>
		...
		Hinduism, let that be 'Brahman' and Islam, let that be 'Allah'.
	...
	<p>
		...
		For example: The more people in a society begin wishing that corruption be gone, and more people begin writing and speaking about it and then begin executing steps towards achieving it &ndash; the higher the chances of the corruption actually ending.<br>
