...
<div id='message'>
	...
	<h3>Why must a model leave things out?</h3>
	<p>
	...
	<p>
		Every model therefore answers an often hidden question: <em>useful for what?</em>
	</p>
	<h3>Is a model a copy of reality?</h3>
	<p>
		No.
	</p>
	<p>
	...
	<h3>What kinds of model are there?</h3>
	<p>
		Models take many forms:
	</p>
	<ul class="list-bullet content-list">
		<li><div><strong>Physical models</strong> — a globe, prototype or scale building</div></li>
		<li><div><strong>Conceptual models</strong> — an explanation of how parts relate</div></li>
		<li><div><strong>Mathematical models</strong> — quantities and equations describing a pattern</div></li>
		<li><div><strong>Statistical models</strong> — relationships estimated from observations</div></li>
		<li><div><strong>Mental models</strong> — the internal expectations used in thought and action</div></li>
		<li><div><strong>Computational models</strong> — representations whose behaviour is simulated by a computer</div></li>
	</ul>
	<p>
		The forms differ, but each stands in for something so that it can be examined more easily.
	</p>
	<h3>How does a model help us predict?</h3>
	<p>
	...
	<h3>How does a model explain?</h3>
	<p>
	...
	<h3>Can a model be wrong and useful?</h3>
	<p>
		Yes.
	</p>
	<p>
	...
	<ul class="list-bullet content-list">
		<li><div>Which parts of reality does it preserve?</div></li>
		<li><div>How accurate is it?</div></li>
		<li><div>Under what conditions does it work?</div></li>
		<li><div>What decision will depend upon it?</div></li>
	</ul>
	<p>
	...
	<h3>How do models shape perception?</h3>
	<p>
	...
	<h3>Is a machine-learning model a program?</h3>
	<p>
