...
<div id='nav-menu'>
	<div id='nav-menu_container'>
		<div class='sidebar-nav-li sidebar-sub'>
			...
			group_image($SIDEBAR_NAV_GROUP, $MENU_MAX_ITEM_COUNT, ['root', getUITranslation('menu_home', $lang)], ['world', getUITranslation('menu_world', $lang)], ['technology', getUITranslation('menu_technology', $lang)]);
