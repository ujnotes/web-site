		...
		<span id='download_button'>
			...
			<script type='text/javascript'>
				function googleTranslateElementInit() {
				  new google.translate.TranslateElement({pageLanguage: 'en', autoDisplay: false, gaTrack: true <?php if($bPublish) echo ", gaId: '".$googleAnalyticsId."'"; ?>}, 'google_translate_element');
				}
			</script>
